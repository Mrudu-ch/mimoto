...
public class VcSdJwtCredentialFormatHandler implements CredentialFormatHandler {
    ...
    private void resolveDecodedClaimValues(Object value, String path, Map<String, Disclosure> digestToDisclosure,
        ...
        if (value instanceof List<?> list) {
            resolveDecodedClaimValuesInList(list, path, digestToDisclosure, pathToValues);
        } else if (value instanceof Map<?, ?> map) {
            resolveDecodedClaimValuesInMap(map, path, digestToDisclosure, pathToValues);
        }
    }

    private void resolveDecodedClaimValuesInList(List<?> list, String path, Map<String, Disclosure> digestToDisclosure,
                                                 Map<String, Object> pathToValues) {
    ...
    private void resolveDecodedClaimValuesInMap(Map<?, ?> map, String path, Map<String, Disclosure> digestToDisclosure,
                                                Map<String, Object> pathToValues) {
        resolveDecodedSdDigests(map.get(SD), path, digestToDisclosure, pathToValues);
    ...
    private void resolveDecodedSdDigests(Object sdDigestsObj, String path, Map<String, Disclosure> digestToDisclosure,
                                         Map<String, Object> pathToValues) {
        if (!(sdDigestsObj instanceof List<?> sdDigests)) return;
    ...
    private void resolveDisclosures(Object value, String path, List<String> parentDisclosures,
            Map<String, Disclosure> digestToDisclosure, Map<String, String> digestToDisclosureB64,
            Map<String, Object> pathToDisclosures) {
        if (value instanceof List) {
            resolveListDisclosures((List<Object>) value, path, parentDisclosures, digestToDisclosure, digestToDisclosureB64, pathToDisclosures);
        } else if (value instanceof Map) {
            resolveMapDisclosures((Map<String, Object>) value, path, parentDisclosures, digestToDisclosure, digestToDisclosureB64, pathToDisclosures);
        }
    }

    @SuppressWarnings("unchecked")
    private void resolveListDisclosures(List<Object> list, String path, List<String> parentDisclosures,
            Map<String, Disclosure> digestToDisclosure, Map<String, String> digestToDisclosureB64,
            Map<String, Object> pathToDisclosures) {
        for (int i = 0; i < list.size(); i++) {
            Object item = list.get(i);
    ...
    private void resolveMapDisclosures(Map<String, Object> map, String path, List<String> parentDisclosures,
            Map<String, Disclosure> digestToDisclosure, Map<String, String> digestToDisclosureB64,
            Map<String, Object> pathToDisclosures) {
        resolveSdDigests(map.get(SD), path, parentDisclosures, digestToDisclosure, digestToDisclosureB64, pathToDisclosures);
    ...
    @SuppressWarnings("unchecked")
    private void resolveSdDigests(Object sdDigestsObj, String path, List<String> parentDisclosures,
            Map<String, Disclosure> digestToDisclosure, Map<String, String> digestToDisclosureB64,
            Map<String, Object> pathToDisclosures) {
        if (!(sdDigestsObj instanceof List)) return;
